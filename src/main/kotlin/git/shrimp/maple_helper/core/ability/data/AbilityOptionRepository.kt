...
class AbilityOptionRepository {
    ...
    init {
        ...
        this.add(9, "모든 능력치 {0} 증가")
        this.add(10, "공격 속도 단계 {0} 증가")
        ...
        this.add(29, "STR {0}, DEX {1} 증가")
        this.add(30, "STR {0}, INT {1} 증가")
        this.add(31, "STR {0}, LUK {1} 증가")
        this.add(32, "DEX {0}, STR {1} 증가")
        this.add(33, "DEX {0}, INT {1} 증가")
        this.add(34, "DEX {0}, LUK {1} 증가")
        this.add(35, "INT {0}, STR {1} 증가")
        this.add(36, "INT {0}, DEX {1} 증가")
        this.add(37, "INT {0}, LUK {1} 증가")
        this.add(38, "LUK {0}, STR {1} 증가")
        this.add(39, "LUK {0}, DEX {1} 증가")
        this.add(40, "LUK {0}, INT {1} 증가")
    }
